...
public class Pipelines {
  ...
  public static DataStream<Object> hoodieStreamWrite(Configuration conf,
    ...
    if (OptionsResolver.isBucketIndexType(conf)) {
      ...
      return dataStream.partitionCustom(partitioner, record -> new HoodieKey(record.getRecordKey(), record.getPartitionPath()))
          .transform(opName("bucket_write", conf), TypeInformation.of(Object.class), BucketStreamWriteOperator.getFactory(conf, rowType))
      ...
      return dataStream
          ...
          .transform(opName("stream_write", conf), TypeInformation.of(Object.class), StreamWriteOperator.getFactory(conf, rowType))
