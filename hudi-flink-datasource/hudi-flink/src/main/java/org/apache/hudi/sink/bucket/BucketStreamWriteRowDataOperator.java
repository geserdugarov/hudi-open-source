...
/**
 * Operator for {@link BucketStreamWriteRowDataFunction}.
 *
 * @param <I> The input type
 */
public class BucketStreamWriteRowDataOperator<I> extends AbstractWriteOperator<I> {

  public BucketStreamWriteRowDataOperator(Configuration conf, RowType rowType) {
