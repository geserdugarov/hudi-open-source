...
public class HoodieTableSink implements
  ...
  public SinkRuntimeProvider getSinkRuntimeProvider(Context context) {
    return (DataStreamSinkProviderAdapter) dataStream -> {
      ...
      if (conf.getBoolean(FlinkOptions.WRITE_OPTIMIZED_SERDE)) {
        final DataStream<Tuple> rowDataStream = Pipelines.bootstrapRowData(conf, rowType, dataStream, context.isBounded(), overwrite);
