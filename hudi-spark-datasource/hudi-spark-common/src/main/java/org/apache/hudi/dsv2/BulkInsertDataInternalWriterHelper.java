...
public class BulkInsertDataInternalWriterHelper {
  ...
  public void write(InternalRow record) throws IOException {
    try {
      String partitionPath = record.getUTF8String(fieldsMap.get(HoodieRecord.PARTITION_PATH_METADATA_FIELD)).toString();
      String fileId = record.get(fieldsMap.get("file_id"), DataTypes.StringType).toString();
